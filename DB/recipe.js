const recipe ={
  "paragraph": [
    ...
    },
    {
      ...
      "textStrong": "Prepare the simple water bath (see note)"
    },
    {
      "stepNumber": 5,
    ...
    {
      "stepNumber": 6,
      "description": "Use a knife to loosen the chilled cheesecake from the rim of the springform pan, then remove the rim. Using a clean sharp knife, cut into slices for serving. For neat slices, wipe the knife clean and dip into warm water between each slice.",
      "textStrong": ""
    },
    {
      "stepNumber": 7,
  ...
  "ingredients": [
    ...
    },
    {
      "recipe2": [
        ...
        {
          "id": "item10",
          "item": "topping suggestions: salted caramel, lemon curd, strawberry topping, chocolate ganache, red wine chocolate ganache, fresh fruit, whipped cream, or raspberry sauce (recipe in notes)"
        }
      ]
    }
  ],
...
export const paragraph = recipe.paragraph;
export const ingredients = recipe.ingredients;
